...
% NB!: this only changes the colors of the titles in the Table of Contents!
\makeatletter
\addtokomafont{partentry}{\color{myColorMainB}}
\addtokomafont{partentrypagenumber}{\color{black}}

\addtokomafont{chapterentrypagenumber}{\color{black}}
...
% everything that belongs to a title but isn't a title:
\addtokomafont{disposition}{\color{myColorMainC}}
