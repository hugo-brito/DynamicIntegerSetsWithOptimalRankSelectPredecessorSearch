...
We will run an example of this algorithm, explaining its intricacies.
...
In order to extract the value of the bit at position $d$ of a $x$, we resort to the algorithm of section~\ref{sec:bit}. Note that:
\begin{itemize}
    \item
