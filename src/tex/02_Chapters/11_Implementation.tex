...
If, as discussed in Section~\ref{sec:universe}, $u = 2^w$ is the size of universe of keys we can store in this data structure, then we can also express the running time as being $O(\log_2(\log_2 u))$.
