...
The following interface methods suffered no changes and serve the same purposed as the implementation from \ref{sec:binaryRankInterfaceImplementation}:
\begin{itemize}
    \item
...
\begin{itemize}
    \item
    {\ttfamily insert(final long x)} keeps all the steps from \ref{sec:binaryRankHelperMethods} and adds the following right after inserting $x$ in the set:
    \begin{enumerate}
        \item
